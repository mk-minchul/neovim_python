...
RUN echo "alias python='python3.6'" >> ~/.bash_aliases && source ~/.bash_aliases
RUN echo "alias pip='python3.6 -m pip'" >> ~/.bash_aliases && source ~/.bash_aliases

' link python3 to 3.6 version with alias python3="python3.6"
' link pip3 to 3.6 version with alias pip3="python3.6 -m pip"
RUN echo "alias python3='python3.6'" >> ~/.bash_aliases && source ~/.bash_aliases
RUN echo "alias pip3='python3.6 -m pip'" >> ~/.bash_aliases && source ~/.bash_aliases


' install nvim related packages for python
RUN pip install neovim pep8 flake8 pyflakes pylint isort
